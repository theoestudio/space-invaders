 ...
 */
export function ink(hex,options,lt,ut){
  let r,g,b,
      o=options||1,
      _h=hex.split(/[,()]/g),
      hex=hex.includes('rgb')?rgb2hex(hex):hex,
...
function rgb2hex(rgb){
  let terms = rgb.split(/[,()]/g),
      r = parseInt(terms[1]).toString(16),
      g = parseInt(terms[2]).toString(16),
      b = parseInt(terms[3]).toString(16);
